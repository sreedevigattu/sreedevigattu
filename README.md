...
|---|---|---|
| Feb - Oct 2022 | **MP excise Data Analysis** @ IIMB | The MP excise team auctions the liquor shops in the state every year. Instead of deciding the auction price ad hoc, they wanted to move towards an evidence based price using machine learning techniques. The liquor consumption data and census data of the past years for various districts was used for the analysis. Clustering and Logistic Regression techniques were used on this data to build models to help the MP excise team with the pricing of liquor shops |
| Nov - Dec 2019 | **Email analysis** @ MCA Technology| Analyse emails to detect mails that could indicate fraud using various text analytics methods like topic modelling (lda), word embedding and network analysis (using gephi).Developed tools using python, pandas, gephi, genism. |
| Mar - Nov 2019 | **Sensitive Data Discovery** @ Netalytics | Develop an implementation idea to identify if a machine contains files with sensitive data using Machine Learning techniques (text mining, neural networks). Used: Elastic Search, python, NLP libraries (nltk, spacy), pandas, scikit learn, keras. |

#### Challenges
| Date | Project | Details| 
|---|---|---|
| Jan-Feb 2021 | **[WiDS Datathon 2021](https://github.com/sreedevigattu/wids2021)** | The WiDS Datathon 2021 focuses on patient health, with an emphasis on the chronic condition of diabetes, through data from MIT’s GOSSIS (Global Open Source Severity of Illness Score) initiative.[Submission](https://www.kaggle.com/code/sreedevigattu/model) |
...
| Date | Project | Details |
|---|---|---|
| Dec 2021 - Nov 2022 | **Crop Residue Management** @ IIMB | CII runs an initiative on Crop Residue Management (CRM) aims to promote the adoption of alternate and sustainable straw management and agricultural practices with an aim to eradicate the conventional practices of open crop residue burning that leads to air pollution in the NCR. CII ran surveys of the initiative for the years 2018, 2019 and 2020. Exploratory data analysis of this data was done, insights were drawn, a data story was built using Tableau explaining the insights and presented to the CII. A case and teaching note was prepared on this analysis. |
...
| *Coming soon..* | <img src="https://swd-community-media.s3.amazonaws.com/media/internet-wayed_.png" alt="De-clutter" style="height:250px; width:400px;"/> |
