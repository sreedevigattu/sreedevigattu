...
| Date | Project | Details |
|---|---|---|
| Dec 2021 - Nov 2022 | **Crop Residue Management** @ IIMB | CII runs an initiative on Crop Residue Management (CRM) aims to promote the adoption of alternate and sustainable straw management and agricultural practices with an aim to eradicate the conventional practices of open crop residue burning that leads to air pollution in the NCR. CII ran surveys of the initiative for the years 2018, 2019 and 2020. Exploratory data analysis of this data was done, insights were drawn, a data story was built using Tableau explaining the insights and presented to the CII. The case and teaching note on this analysis is [published at the Harvard Business Publishing](https://hbsp.harvard.edu/product/IMB959-PDF-ENG?activeTab=overview). |
